...
| **MCP Server** | Stdio MCP server exposing 20 focused flow, consultation, memory, docs, web, identity, history, and diagnostics tools | `src/mcp/server.ts`, `src/mcp/runtime.ts` |
